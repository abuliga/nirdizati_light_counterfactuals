...
def dice_explain(CONF, predictive_model, cf_df, encoder, df, query_instances, method, optimization, support,
                 timestamp_col_name,model_path,case_ids=None,random_seed=None,adapted=None,filtering=None):
    ...
    if adapted & (method == 'multi_objective_genetic_adapted'):
        ...
        for k in [5,10,15,20]:
            ...
            if method == 'genetic_conformance':
                dice_result = dice_query_instance.generate_counterfactuals(x,encoder=encoder, desired_class='opposite',
                                                                          ...
                                                                          random_seed=random_seed,adapted=adapted)
